...
// and set *pent to the directory entry in pdir associated with the file.
//
...
int
walk_path(const char *path, struct inode **pdir, struct inode **pino, struct dirent **pent, char *lastelem)
{
	const char *p;
	char name[NAME_MAX];
